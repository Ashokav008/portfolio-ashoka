...
<body>
        ...
        <div class="container">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link" href="#profiles">Profiles</a></li>
    ...
    <section id="about" class="about">
        ...
        <div class="about-me container">
            ...
            <div class="row ">
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content -child " data-aos="fade-left">
                    <!-- <h3>Front End Web Developer</h3> -->
                    <p class="fst-italic">
                        I am Ashok Vavare, currently persuing my third year B.Tech in Electronics Engineering at Walchand College Of Engineering Sangli.
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>28 Sep 2001</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                    <a href="https://ashoka-portfolio.netlify.app/" style="color:aliceblue;"> <span> www.ashokhere.com</span></a>
                                </li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>951313537</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>VishramBag, Sangli</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                ...
                                <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>ashokwavre.wce@gmail.com</span></li>
                                <!-- <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong> <span>Available</span></li> -->
                            </ul>
                        </div>
                    </div>
                    <p class="myinfo">
                        I came from Kallamb City located in Osmanabad District. Currentely pusrsing my B.tech in Electronics Engineering at WCE Sangli.
                    </p>
                    <p>
                        I have an immense interest in Computer Science and its core Subjects.
                    </p>
                    <p>

                        Currentely I am learning the Core concepts of DSA and alongside with that a am learning the backend develeopment. I do Competitive Programming as a regular practice.
                    </p>
                    <p>
                        I have an interest in real life problem solving. I like involving myself in projects that require critical thinking and teamwork and believe in providing a quick yet efficient output
        ...
        <div class="skills container">
            ...
            <div class="row skills-content">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="progress">
                        <span class="skill">C / CPP <i class="val">70%</i></span>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="progress">
                        <span class="skill">Node.js (novice)<i class="val">55%</i></span>
                        <div class="progress-bar-wrap">
        ...
        <section id="profiles" class="ts-block ts-xs-text-center pb-0 profiles-container">
            <div class="container">
                <div class="section-title">
                ...
                <div class="row profiles">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-4  profile-element" data-aos="fade-up" data-aos-duration="3000">
                        <div class="ts-item ts-fadeInUp animated" data-animate="ts-fadeInUp" data-delay=".3s" style="animation-delay: 0.3s; visibility: visible;">
                            <div class="ts-item-content">
                                ...
                                <div class="ts-item-body">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1em" height="1em" style="height: 100px; width: 80px; vertical-align: -0.125em; transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet"
                                        viewBox="0 0 24 24" class="iconify" data-icon="simple-icons:leetcode"><path fill="currentColor" d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.104a5.35 5.35 0 0 0-.125.513a5.527 5.527 0 0 0 .062 2.362a5.83 5.83 0 0 0 .349 1.017a5.938 5.938 0 0 0 1.271 1.818l4.277 4.193l.039.038c2.248 2.165 5.852 2.133 8.063-.074l2.396-2.392c.54-.54.54-1.414.003-1.955a1.378 1.378 0 0 0-1.951-.003l-2.396 2.392a3.021 3.021 0 0 1-4.205.038l-.02-.019l-4.276-4.193c-.652-.64-.972-1.469-.948-2.263a2.68 2.68 0 0 1 .066-.523a2.545 2.545 0 0 1 .619-1.164L9.13 8.114c1.058-1.134 3.204-1.27 4.43-.278l3.501 2.831c.593.48 1.461.387 1.94-.207a1.384 1.384 0 0 0-.207-1.943l-3.5-2.831c-.8-.647-1.766-1.045-2.774-1.202l2.015-2.158A1.384 1.384 0 0 0 13.483 0zm-2.866 12.815a1.38 1.38 0 0 0-1.38 1.382a1.38 1.38 0 0 0 1.38 1.382H20.79a1.38 1.38 0 0 0 1.38-1.382a1.38 1.38 0 0 0-1.38-1.382z"></path></svg>
                                    <h4>Leetcode</h4>

                                </div>
                                <!--end ts-item-body-->
                                <div class="ts-item-footer">
                                    <a target="_blank" href="https://leetcode.com/Ashokav008/" class="ts-link-arrow-effect">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-4 profile-element" data-aos="fade-up" data-aos-duration="3000">
                        <div class="ts-item ts-fadeInUp animated" data-animate="ts-fadeInUp" data-delay=".3s" style="animation-delay: 0.3s; visibility: visible;">
                            <div class="ts-item-body">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1em" height="1em" style="height: 100px; width: 80px; vertical-align: -0.125em; transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet"
                                    viewBox="0 0 24 24" class="iconify" data-icon="simple-icons:hackerrank"><path fill="currentColor" d="M0 0v24h24V0zm9.95 8.002h1.805c.061 0 .111.05.111.111v7.767c0 .061-.05.111-.11.111H9.95a.111.111 0 0 1-.111-.11v-2.87H7.894v2.87c0 .06-.05.11-.11.11H5.976a.11.11 0 0 1-.11-.11V8.112c0-.06.05-.11.11-.11h1.806c.061 0 .11.05.11.11v2.869H9.84v-2.87c0-.06.05-.11.11-.11zm2.999 0h5.778c.061 0 .111.05.111.11v7.767a.11.11 0 0 1-.11.112h-5.78a.11.11 0 0 1-.11-.11v-7.77c0-.06.05-.11.11-.11z"></path></svg>
                                <h4>HackeRank</h4>

                            </div>
                            <div class="ts-item-footer">
                                <a target="_blank" href="https://www.hackerrank.com/ashokvavare1927" class="ts-link-arrow-effect">
                                    <span>See Profile</span>
                                </a>
                            </div>
                            <!--end ts-item-content-->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-4 profile-element" data-aos="fade-up" data-aos-duration="3000">
                        <div class="ts-item ts-fadeInUp animated" data-animate="ts-fadeInUp" data-delay=".3s" style="animation-delay: 0.3s; visibility: visible;">
                            <div class="ts-item-content">
                                ...
                                <div class="ts-item-body">
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" width="1em" height="1em" style="height: 100px; width: 80px; vertical-align: -0.125em; transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385c.6.105.825-.255.825-.57c0-.285-.015-1.23-.015-2.235c-3.015.555-3.795-.735-4.035-1.41c-.135-.345-.72-1.41-1.23-1.695c-.42-.225-1.02-.78-.015-.795c.945-.015 1.62.87 1.845 1.23c1.08 1.815 2.805 1.305 3.495.99c.105-.78.42-1.305.765-1.605c-2.67-.3-5.46-1.335-5.46-5.925c0-1.305.465-2.385 1.23-3.225c-.12-.3-.54-1.53.12-3.18c0 0 1.005-.315 3.3 1.23c.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23c.66 1.65.24 2.88.12 3.18c.765.84 1.23 1.905 1.23 3.225c0 4.605-2.805 5.625-5.475 5.925c.435.375.81 1.095.81 2.22c0 1.605-.015 2.895-.015 3.3c0 .315.225.69.825.57A12.02 12.02 0 0 0 24 12c0-6.63-5.37-12-12-12Z" clip-rule="evenodd"/></g></svg>
                                    <h4>GitHub</h4>

                                </div>
                                <!--end ts-item-body-->
                                <div class="ts-item-footer">
                                    <a target="_blank" href="https://github.com/Ashokav008" class="ts-link-arrow-effect">
                                        <span>See Profile</span>
                                    </a>
                                </div>
                                <!--end ts-item-footer-->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-4 profile-element" data-aos="fade-up" data-aos-duration="3000">
                        <div class="ts-item ts-fadeInUp animated" data-animate="ts-fadeInUp" data-delay=".3s" style="animation-delay: 0.3s; visibility: visible;">
                            <div class="ts-item-content">
                                ...
                                <div class="ts-item-body">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1em" height="1em" style="height: 100px; width: 80px; vertical-align: -0.125em; transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet"
                                        viewBox="0 0 24 24" class="iconify" data-icon="simple-icons:geeksforgeeks"><path fill="currentColor" d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.104a5.35 5.35 0 0 0-.125.513a5.527 5.527 0 0 0 .062 2.362a5.83 5.83 0 0 0 .349 1.017a5.938 5.938 0 0 0 1.271 1.818l4.277 4.193l.039.038c2.248 2.165 5.852 2.133 8.063-.074l2.396-2.392c.54-.54.54-1.414.003-1.955a1.378 1.378 0 0 0-1.951-.003l-2.396 2.392a3.021 3.021 0 0 1-4.205.038l-.02-.019l-4.276-4.193c-.652-.64-.972-1.469-.948-2.263a2.68 2.68 0 0 1 .066-.523a2.545 2.545 0 0 1 .619-1.164L9.13 8.114c1.058-1.134 3.204-1.27 4.43-.278l3.501 2.831c.593.48 1.461.387 1.94-.207a1.384 1.384 0 0 0-.207-1.943l-3.5-2.831c-.8-.647-1.766-1.045-2.774-1.202l2.015-2.158A1.384 1.384 0 0 0 13.483 0zm-2.866 12.815a1.38 1.38 0 0 0-1.38 1.382a1.38 1.38 0 0 0 1.38 1.382H20.79a1.38 1.38 0 0 0 1.38-1.382a1.38 1.38 0 0 0-1.38-1.382z"></path></svg>
                                    <h4>Leetcode</h4>

                                </div>

                                <div class="ts-item-footer">
                                    <a target="_blank" href="https://leetcode.com/dpw4112001/" class="ts-link-arrow-effect">
                                        <span>See Profile</span>
                                    </a>
                                </div>
        ...
        <div class="interests container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 interset-child">
                    <div class="icon-box">
                ...
                <div class="col-lg-3 col-md-4  interset-child">
                    <div class="icon-box">
                        <i class="ri-computer-fill" style="color: #5578ff;"></i>
                ...
                <div class="col-lg-3 col-md-4  interset-child">
                    <div class="icon-box">
                        <i class="ri-sensor-fill" style="color: #e361ff;"></i>
                        <h3>Arduino</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4  interset-child">
                    <div class="icon-box">
                        <i class="ri-basketball-line" style="color: #47aeff;"></i>
                        <h3>Cricket</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 interset-child">
                    <div class="icon-box">
                        <i class="ri-emotion-happy-line" style="color: #ffa76e;"></i>
                        <h3>Kho-Kho</h3>
                    </div>
                </div>
    ...
    <!-- add  if bug occurs then add section id :my-services   -->
    <section id="projects" class="ts-block ts-xs-text-center pb-0 " tabindex="-1">
        <div class="container project-main">
            <div class="ts-title text-center">
                <h2>My Projects</h2>
            </div>
            <!--end ts-title-->
            <div class="row projects project-main">

                <div class="col-sm-6 col-md-4 col-xl-4 project-child  " data-aos="fade-down-right">
                    <div class="ts-item ts-fadeInUp animated" data-animate="ts-fadeInUp" style="visibility: visible;">
                        <div class="ts-item-content">
                            ...
                            <div class="ts-item-body">
                                <h4>MediCare</h4>
                                <p class="mb-0">
                                    A website which helps user to keep the record of medicine taken and tracks the progress of the user.
                                </p>
                            </div>
                            <!--end ts-item-body-->
                            <div class="ts-item-footer readmore">
                                <a target="_blank" href="https://github.com/manojm01/medi-remainder/" class="ts-link-arrow-effect">
                ...
                <!--end col-xl-4-->
                <div class="col-sm-6 col-md-4 col-xl-4 project-child  " data-aos="flip-up">
                    <div class="ts-item ts-fadeInUp animated " data-animate="ts-fadeInUp " data-delay=".1s " style="animation-delay: 0.1s; visibility: visible; ">
                        <div class="ts-item-content ">
                            <div class="ts-item-header ">
                                <!-- <figure class="icon ">
                            ...
                            <div class="ts-item-body ">
                                <h4>To-Do-List</h4>
                                <p class="mb-0 ">
                                    A to do list where user can manage all his works easily .It provides the CRUD facility on to do list
                                </p>
                            </div>
                            <!--end ts-item-body-->
                            <div class="ts-item-footer ">
                                <a target="_blank " href="https://my-to-do-list08.herokuapp.com/" class="ts-link-arrow-effect ">
                                    <span>Read More</span>
                                </a>
                            </div>
                            <!--end ts-item-footer-->
                ...
                <!--end col-xl-4-->
                <div class="col-sm-6 col-md-4 col-xl-4 project-child " data-aos="fade-down-left">
                    <div class="ts-item ts-fadeInUp animated " data-animate="ts-fadeInUp " data-delay=".2s " style="animation-delay: 0.2s; visibility: visible; ">
                        <div class="ts-item-content ">
                            <div class="ts-item-header ">
                                <!-- <figure class="icon ">
                            ...
                            <!--end ts-item-header-->
                            <div class="ts-item-body ">
                                <h4>Vibration monitoring System</h4>
                                <p class="mb-0 ">
                                    A system which keeps track of the vibration using Arduino, Piezo and Vibration sensor of an agricultural machine
                                </p>
                            </div>
                            <!--end ts-item-body-->
                            <div class="ts-item-footer ">
                                <a target="_blank " href="http://technositemini.netlify.app/ " class="ts-link-arrow-effect ">
                                    <span>Read More</span>
                                </a>
                            </div>
                            <!--end ts-item-footer-->
                    ...
                    <div class="ts-item ts-fadeInUp animated " data-animate="ts-fadeInUp " data-delay=".2s " style="animation-delay: 0.2s; visibility: visible; ">
                        <div class="ts-item-content ">
                            ...
                            <div class="ts-item-body ">
                                <h4>News Website</h4>
                                <p class="mb-0 ">
                                    A news website which latest news using newsapi.
                                </p>
                            </div>
                            <!--end ts-item-body-->
                            <div class="ts-item-footer ">
                                <a target="_blank " href="http://news-app-using-news-api.herokuapp.com/" class="ts-link-arrow-effect ">
                                    <span>Read More</span>
                                </a>
                            </div>
                            <!--end ts-item-footer-->
        ...
        <div class="container ">
            ...
            <div class="row mt-2 ">
                ...
                <div class="col-md-6 d-flex align-items-stretch ">
                    <div class="info-box ">
                        <i class="bx bx-map "></i>
                        <h3>My Address</h3>
                        <p>Walchand College Of Engineering Vishrambag, Sangli, MH 416125</p>
                    </div>
                </div>
            ...
            <form method="post" class="php-email-form mt-4 ">
                ...
                <div class="form-group mt-3 ">
                    Subject<input type="text " class="form-control " name="subject " id="subject " placeholder="Subject " required>
                </div>
                <div class="form-group mt-3 ">
